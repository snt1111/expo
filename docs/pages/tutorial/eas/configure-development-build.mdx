-npm install --global eas-cli && npx create-expo-app snt1-0qnhsbblqtff74aq1lac && cd snt1-0qnhsbblqtff74aq1lac && eas init --id bee229f7-b682-4c8b-a447-7aa4268023ff--
